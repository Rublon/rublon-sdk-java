...
abstract public class RublonWidget {
	 ...
	 * HTML template.
	 */
	private static final String TEMPLATE = "<div class=\"rublon-widget\" ><iframe %s frameBorder=\"0\" style=\"width: 100%%\"></iframe></div>";
	...
	public String toString() {
		...
		return String.format(TEMPLATE, createAttributesString(attr)) + getAdditionalHTML();
	}
	...
	/**
	 * Get widget's additional HTML content.
	 */
