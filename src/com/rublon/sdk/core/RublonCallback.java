 ...
 */
abstract public class RublonCallback {
	 ...
	 */
	public RublonCallback(RublonConsumer rublon) throws ConfigurationException {
	 ...
	 * @return void
	 */
	abstract protected void userAuthenticated(String userId);
